...
namespace ControleEstoque.Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        void Application_Error(object sender, EventArgs e) // TRATAMENTO DE MENSAGEM DE ERRO PARA O PASSA OS DADOS
        {
        ...
        protected void Application_AuthenticateRequest(Object sender, EventArgs e)
        {
            ...
            if (cookie != null && cookie.Value != string.Empty)
            {
                ...
                catch
                {
                    ...
                    //{
                    //    Context.User = new GenericPrincipal(Context.User.Identity, perfis1);
                    //}
