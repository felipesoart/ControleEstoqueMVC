...
namespace ControleEstoque.Web.Controllers.Cadastro
{
    public class CadProdutoController : Controller
    {
        ...
        {
            var lista = ProdutoModel.RecuperarLista(pagina, tamPag, filtro);
        ...
        {
            /* isso agora faz parte do metodo excluir do ProdutoModel
            var ret = false;
            ...
            if (id > 0)
            {
                nomeArquivoImagemAnterior = ProdutoModel.RecuperarImagemPeloId(id);
            }
