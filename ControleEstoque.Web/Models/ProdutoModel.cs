...
namespace ControleEstoque.Web.Models
{
    public class ProdutoModel
    {
        ...
        public static List<ProdutoModel> RecuperarLista(int pagina = 0, int tamPagina = 0, string filtro = "", bool somenteAtivos = false)
        {
                        ...
                        foreach (var produto in produtos)
                        {
                            using (var comando = new SqlCommand())
                            {
                                ...
                                comando.CommandText =
                                    ...
                                    "(numero, data, id_produto, quant) " +
                                    "values (@numero, @data, @id_produto, @quant); select convert(int, scope_identity())";
